...
func (c *gRPCMdtDialoutClient) MdtDialout(ctx context.Context, opts ...grpc.CallOption) (GRPCMdtDialout_MdtDialoutClient, error) {
	...
	x := &gRPCMdtDialoutMdtDialoutClient{ClientStream: stream}
	return x, nil
}

type GRPCMdtDialout_MdtDialoutClient interface {
	Send(*MdtDialoutArgs) error
	Recv() (*MdtDialoutResponse, error)
	grpc.ClientStream
}
...
func (x *gRPCMdtDialoutMdtDialoutClient) Recv() (*MdtDialoutResponse, error) {
	m := new(MdtDialoutResponse)
...
func _GRPCMdtDialout_MdtDialout_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GRPCMdtDialoutServer).MdtDialout(&gRPCMdtDialoutMdtDialoutServer{ServerStream: stream})
}

type GRPCMdtDialout_MdtDialoutServer interface {
	Send(*MdtDialoutResponse) error
...
func (x *gRPCMdtDialoutMdtDialoutServer) Send(m *MdtDialoutResponse) error {
